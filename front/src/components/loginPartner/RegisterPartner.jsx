...
const RegisterDriver = () => {
  ...
  return (
    <div className="register-container-driver">
      ...
      <form className="register-driver-form" onSubmit={createDriver}>
        <div className="register-driver-container-input">
          <label className="register-driver-label" htmlFor="name">
            Nom :
          </label>
          <input
            className="register-driver-input"
            type="name"
            value={lastname}
        ...
        <div className="register-driver-container-input">
          <label className="register-driver-label" htmlFor="email">
            E-mail :
          </label>
          <input
            className="register-driver-input"
        ...
        <div className="register-driver-container-input">
          <label className="register-driver-label" htmlFor="password">
            Mot de passe :
          </label>
        ...
        <div className="register-driver-container-input">
          <label className="register-driver-label" htmlFor="address">
            Adresse :
          </label>
          <input
            className="register-driver-input"
        ...
        <div className="register-driver-container-input">
          <label className="register-driver-label" htmlFor="number">
            N° siret :
          </label>
          <input
            className="register-driver-input"
            type="number"
            value={numberSiret}
            onChange={event => setNumberSire(event.target.value)}
          />
        </div>
        <div className="register-driver-container-input">
          <label className="register-driver-label" htmlFor="number">
